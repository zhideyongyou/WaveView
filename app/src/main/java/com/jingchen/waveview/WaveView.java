...
public class WaveView extends View {
    ...
    private void init() {
        ...
        timer = new Timer();
        //组件
        mPaint = new Paint();//组件初始化
        mPaint.setAntiAlias(true);
        mPaint.setStyle(Style.FILL);//设置风格
        mPaint.setColor(Color.BLUE);//设置进度的颜色
        //百分比
        mTextPaint = new Paint();//百分比初始化
        mTextPaint.setColor(Color.WHITE);//设置百分比展示的颜色
        mTextPaint.setTextAlign(Align.CENTER);//设置百分比展示的位置
        mTextPaint.setTextSize(30);//设置百分比展示的大小
